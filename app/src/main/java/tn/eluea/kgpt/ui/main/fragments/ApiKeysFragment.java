...
public class ApiKeysFragment extends Fragment implements AdditionalApiKeysAdapter.OnKeyActionListener {
    ...
    private MaterialButton btnSaveGemini, btnAddKey;
    ...
    private void showInfoBottomSheet() {
        ...
        tvTitle.setText("About API Keys");
        tvDescription.setText("API keys are required to use AI services.\n\n" +
                "• Gemini API Key: Get your free key from Google AI Studio (aistudio.google.com)\n\n" +
                "• ChatGPT: Get your key from OpenAI Platform (platform.openai.com)\n\n" +
                "• Claude: Get your key from Anthropic Console (console.anthropic.com)\n\n" +
                "• Security: Your API keys are stored securely on your device and never shared with anyone.\n\n" +
                "Tip: You can add multiple API keys for different providers.");
    ...
    private void showAddKeyBottomSheet() {
        ...
        for (LanguageModel model : availableModels) {
            View optionView = LayoutInflater.from(requireContext()).inflate(R.layout.item_provider_option, providersContainer, false);
