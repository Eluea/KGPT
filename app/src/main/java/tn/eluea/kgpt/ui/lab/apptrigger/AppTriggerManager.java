 ...
 * Uses XSharedPreferences (via XposedConfigReader) when running in Xposed module context.
 */
public class AppTriggerManager {
    ...
    private void loadTriggers() {
        ...
        if (XposedConfigReader.isAvailable()) {
            ...
            Log.d(TAG, "loadTriggers() from XSharedPreferences: " + (encoded != null ? encoded.length() + " chars" : "null"));
        }
    ...
    public void saveTriggers() {
        ...
        // This is important for LSPosed's New XSharedPreferences
        try {
    ...
    public boolean isFeatureEnabled() {
        ...
        if (XposedConfigReader.isAvailable()) {
            boolean enabled = XposedConfigReader.getBoolean(PREF_APP_TRIGGERS_ENABLED, false);
        ...
        configClient.clearCache();
        boolean enabled = configClient.getBoolean(PREF_APP_TRIGGERS_ENABLED, false);
    ...
    public List<InstalledApp> getInstalledApps() {
        ...
        for (android.content.pm.PackageInfo packageInfo : packages) {
            ...
            try {
                ...
                if (defaultActivityName == null) continue;
