...
public class SettingsFragment extends Fragment {
    ...
    private void executeRestore() {
        ...
        if (result.success) {
            ...
            if (pendingRestoreOptions.isSelected(BackupOptions.Option.APP_TRIGGERS)) {
                tn.eluea.kgpt.ui.lab.apptrigger.AppTriggerManager triggerManager = 
                    tn.eluea.kgpt.ui.lab.apptrigger.AppTriggerManager.getInstance();
    ...
    private void showChangelogBottomSheet() {
        ...
        // Major Update Notice
        addChangelogEntry(changelogContent, "NEW", "Massive update with tons of changes! I've lost count of how many improvements were made. Explore and discover them yourself - this is a major and substantial update!", colorSecondary, colorOnSecondary);
