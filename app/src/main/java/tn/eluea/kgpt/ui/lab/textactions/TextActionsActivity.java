...
public class TextActionsActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        findViewById(R.id.btn_add_custom_action)
                .setOnClickListener(v -> showAddCustomActionDialog(new TextActionManager(this)));

        // Main toggle
        switchEnabled.setOnCheckedChangeListener((buttonView, isChecked) -> {
            configClient.putBoolean(PREF_TEXT_ACTIONS_ENABLED, isChecked);
            updateContentVisibility(isChecked);
    ...
    private void populateActionsList() {
        ...
        // Custom Actions
        java.util.List<tn.eluea.kgpt.textactions.CustomTextAction> customActions = actionManager.getCustomActions();
        for (tn.eluea.kgpt.textactions.CustomTextAction action : customActions) {
            ...
            icon.setColorFilter(Color.parseColor("#FFC107")); // Amber/Gold color
    ...
    private void showEditCustomActionDialog(tn.eluea.kgpt.textactions.CustomTextAction action,
    ...
    private void showDeleteCustomActionBottomSheet(tn.eluea.kgpt.textactions.CustomTextAction action,
            TextActionManager actionManager,
