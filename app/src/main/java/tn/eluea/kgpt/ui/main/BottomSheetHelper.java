...
public class BottomSheetHelper {
    ...
    public static void applyTheme(Context context, View sheetView) {
        ...
        if (container != null) {
            if (isDarkMode && isAmoled) {
                ...
                container.setBackgroundResource(R.drawable.bg_bottom_sheet_floating_dark);
            } else {
    ...
    public static void makeEdgeToEdgeOriginal(BottomSheetDialog dialog, View sheetView) {
        ...
        dialog.setOnShowListener(dialogInterface -> {
            ...
            FrameLayout bottomSheet = d.findViewById(com.google.android.material.R.id.design_bottom_sheet);
            if (bottomSheet != null) {
                // Set the background with rounded top corners on the Material bottom sheet container
    ...
    private static int getBottomSheetBackgroundDrawable(Context context) {
        ...
        if (isDarkMode && isAmoled) {
            ...
            return R.drawable.bg_bottom_sheet_material_dark;
        } else {
