...
public class SelectionHandler {
    ...
    private void registerResultReceiver() {
                            ...
                            if (ic != null) {
                                ...
                                if (start >= 0 && end >= 0 && start != end) {
                                    ...
                                    tn.eluea.kgpt.util.Logger
                                            .log("Replaced " + selectedLength + " chars at [" + selStart + ", " + selEnd
                                                    + "] with " + text.length() + " chars");
                                } else {
        ...
        // Use ContextCompat for proper backward compatibility
        ContextCompat.registerReceiver(context, resultReceiver, filter, ContextCompat.RECEIVER_EXPORTED);
