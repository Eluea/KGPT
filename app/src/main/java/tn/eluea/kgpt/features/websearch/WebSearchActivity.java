...
public class WebSearchActivity extends AppCompatActivity {
    ...
    private String buildSearchUrl(String engine, String query) {
        ...
        switch (engine) {
            ...
            case "copilot":
                return "https://www.bing.com/search?q=" + encodedQuery + "&showconv=1";
            case "blackbox":
                return "https://www.blackbox.ai/?q=" + encodedQuery;
            case "duckduckgo":
            default:
    ...
    private String extractSearchQuery(String url) {
        try {
            ...
            // You.com
            if (host.contains("you.com")) {
                return uri.getQueryParameter("q");
            }
            // Copilot (Bing)
            if (host.contains("bing.com") && url.contains("showconv=1")) {
                return uri.getQueryParameter("q");
            }
            // Blackbox AI
            if (host.contains("blackbox.ai")) {
                return uri.getQueryParameter("q");
            }
        } catch (Exception e) {
